                    ...
                    <div class="col-lg-8 col-xl-6">
                        ...
                        <form action="{{route('login.post')}}" method="POST">
                            ...
                            <div style="display: flex; justify-content: space-between;  align-items: center;">
                                <button type="submit" class="btn btn-primary" style="height: 6vh;">Login</button>
                                <div>
                                    <h7 class="resize-title">Don't have an anccount?</h7>
                                    <a href="{{route('registration')}}" class="text-align-center">
